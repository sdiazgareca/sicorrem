...
<div class="usuario">Usuario: <strong><?php echo $usuario['nombre'].' '.$usuario['apellido']; ?></strong></div><!-- usuario -->
<div id="contenido">
...
?>
<li><a href="MEN/m_link.php?modulo=<?php echo $modulos['cod_modulo']; ?>&cod_usuario=<?php echo $usuario['cod_usuario']; ?>" class="enlace"><span><?php echo $modulos['modulo_nombre']; ?></span></a></li>

<?php
}
echo '<li><a href="MAUAL_SICOREMM.pdf" class="enlace"><span>MANUAL</span></a></li>';
echo "</ul>";
?>
</div>
