...
WHERE contratos.f_ingreso <='".$periodo."' AND (f_baja >='".$periodo."' || f_baja ='0000-00-00') AND contratos.factu = 'C' AND contratos.tipo_plan =3 ORDER BY titulares.apellido";
...
<?
    ...
    echo '<form action="BUSQ/FACT_AP_FC.php" method="post" id="'.$planes['num_solici'].'">';
