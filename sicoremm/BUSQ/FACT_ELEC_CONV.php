...
$nempresa = "SELECT comprovante,cod_mov,contratos.ajuste,DATE_FORMAT(contratos.f_ingreso,'%d-%m-%Y') AS f_ingreso, DATE_FORMAT(contratos.f_baja,'%d-%m-%Y') AS f_baja,debe,
       e_contrato.descripcion AS des_estado,valor_plan.valor,contratos.num_solici,contratos.f_ingreso,contratos.secuencia,titulares.nro_doc, CONCAT(titulares.apellido,' ',titulares.nombre1) AS nombres
                FROM titulares
