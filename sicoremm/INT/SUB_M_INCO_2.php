...
if ($_POST['ff_t_credito'] == ''){
    $_POST['ff_t_credito'] =0;

}

if($query1 > 0){

$Quuu = 'INSERT INTO ventas_reg(mes_pago_inicial,num_solici,titular,vendedor,monto,fecha,cat_venta,
    estado_venta,pago_venta,fecha_documento,t_documento,bancos,t_credito,f_ingreso,n_che_tar,rendicion,sec)
        ...
        VALUES("'.$mes_pago_inicial.'","'.$_POST['num_solici'].'","'.$_POST['titular'].'",
            ...
            "'.$_POST['ff_t_credito'].'","'.date('Y-m-d').'","'.$_POST['n_che_tar'].'","'.$_POST['rendicion'].'",
            "'.$_POST['sec'].'")';
...
<table class="table">
    ...
    <tr>
        ...
        <td><strong>MENSUALIDAD</strong></td><td><?php echo ($_POST['mensualidad'] + $_POST['ajuste']); ?></td>
