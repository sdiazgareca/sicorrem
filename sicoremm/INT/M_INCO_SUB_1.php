...
$dat->Trans($inser);
	...
	$query = mysql_query($campos);
        ...
        $afiliado->VerAfiliado($_POST['num_solici'],'',0,$rut->nro_doc);
...
if ($_POST['BOLL']){
	...
	$query2['boleta'] = "UPDATE sicoremm2.ventas_reg SET estado_veta=300, n_documento='".$_POST['n_boleta']."',locominion='".$comi['locomocion']."' WHERE num_solici='".$_POST['num_solici']."' AND cat_venta='200' AND vendedor='".$comi['vendedor']."'";
	$query2['contrato'] = "UPDATE sicoremm2.contratos SET estado='500' WHERE num_solici='".$_POST['num_solici']."'";
	...
	$contrato->Imprimir($campos,"contr",$where,'2',$rut);
        ...
        $valorMensual->ValorMensual($_POST['num_solici'],0);
