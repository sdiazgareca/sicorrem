...
if ( isset($_POST['ff_bus_psalu']) ){
	...
	foreach($_POST as $campo => $valor){ 	
		...
		if ($valor != $_POST['ff_bus_psalu'] && $valor != ""){
				if (is_numeric($valor)){
	...
	$get1 = array("nro_doc"=>"","cod_tipo"=>"");
	$get2 = array("nro_doc"=>"","cod_tipo"=>"");	
	$get1_var = array("VER"=>'1');
	$get2_var = array("ELIMINAR"=>'1');	
	$campos = array("nro_doc"=>"","descripcion"=>"","reducido"=>"","isapre"=>"","cod_tipo"=>"");
	$rut = array("NULL"=>"");
	$datos->Listado_per($campos,"PSALUD",$condicion,"VER","ELIMINAR",$get1,$get2,"INT/M_PSALU.php",$rut,$get1_var,$get2_var,"table");
...
if ( isset($_GET['VER']) ){
	...
	echo '<div class="caja"><strong>DETALLE PREVISI&Oacute;N DE SALUD</strong></div>';
	$datos = new Datos;
	$campos = array("nro_doc AS NUMERO"=>"","descripcion AS NOMBRE"=>"","reducido AS REDUCIDO"=>"","cod_tipo AS COD_TIPO"=>"","isapre AS TIPO"=>"");
	$rut = array('NULL'=>"");
	$condicion= array("nro_doc ='"=>$_GET['nro_doc']."'","cod_tipo = '"=>$_GET['cod_tipo']."'");		
	echo "<div class='caja'>";
	$datos->Imprimir($campos,'PSALUD',$condicion,3,$rut);
...
<td><input type="text" name="descripcion" size="40" value="<?php echo $isapre['descripcion']; ?>" /></td>
</tr>
...
<td><div align="right"><input type="submit" value="EDITAR" class="boton" /></div></td>
</tr>
</table>
