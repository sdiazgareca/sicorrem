...
if ($_GET['ver']){
	...
	$num2 = $valorMensual->cuentaGrupoFam($_GET['CONTRATO']);
	...
	$stop = ( ($comi['secuencia'] + $_GET['SEC']) - $num2);
...
<div id="ing<?php echo $i; ?>" name="ing<?php echo $i; ?>">
	...
	<h1>Ingreso Afiliado</h1>

	<form action="INT/M_INCO_SUB_1.php" method="post" id="ingreso<?php echo $i; ?>" name="ingreso<?php echo $i; ?>">
	<table class="table">
	<tr>
	...
	<td><strong>cod_baja</strong></td><td><input type="text" name="cod_baja" value="00"/></td>
        <td style="display:none;"><input type="text" name="SEC" value="<?php echo $_GET['SEC']; ?>" /></td>
	</tr>
...
<form action="INT/M_CONT_SUB_2.php" method="post" id="bol" name="bol">
<table class="table2">
<tr>
<td><strong>N BOLETA</strong></td>
<td><input type="text" name="n_boleta" /></td>
<td style=" display:none;"><input type="text" name="rendicion" name="<?php echo $_GET['RENDICION']; ?>" /></td>
<td><select name="tipo_doc"><option value="B">Boleta</option><option value="C">Factura Electronica</option></select>
<td><input type="submit" value="Guardar" class="boton" /></td>
</tr>

<tr style="display:none;">
<td><input type="text" name="BOLL" value="1"/></td>
<td><input type="text" name="num_solici" value="<?php echo $_GET['CONTRATO']; ?>"/></td>
<td><strong>cod_plan</strong></td><td><input type="text" name="cod_plan" value="<?php echo $comi['cod_plan']; ?>"/></td>
<td><strong>tipo_plan</strong></td><td><input type="text" name="tipo_plan" value="<?php echo $comi['tipo_plan']; ?>"/></td>
</tr>
...
if ($_POST['ff_listado'] > 0){
	...
	$campos = array ("CONTRATO"=>"","TITULAR"=>"","DESCRIPCION"=>"","PLAN"=>"","SEC"=>"","rendicion AS RENDICION"=>"");
	$rut = array("NULL"=>"");
	$get_var1 = array("ver"=>"1");
	$get_var2 = array("anular"=>"1");
	$get = array ("CONTRATO"=>"","SEC"=>"","RENDICION"=>"");
	$rut = array("TITULAR"=>"");
	$contrato->Listado_per($campos,'INCOR_P',$condicion,'Ver','Anular',$get,$get,'INT/M_INCO_CON.php',$rut,$get_var1,$get_var2,'table');
