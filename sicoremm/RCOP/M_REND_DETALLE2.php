...
echo '<br /><br />';
echo '<a href="DETALLECOB.php?periodo='.$inicio.'&cobrador='.$_POST['cobrador'].'&cierre1='.$cierre1.'&cierre2='.$cierre2.'&cierre3='.$cierre3.'">DETALLE COBRANZA</a>';
echo '<br /><br />';

$c1 = explode("-",$_POST['cierre1']);
$c2 = explode("-",$_POST['cierre2']);
$c3 = explode("-",$_POST['cierre3']);

$f_cierre1= $c1[0].'/'.$c1[1].'/'.$c1[2];
$f_cierre2= $c2[0].'/'.$c2[1].'/'.$c2[2];
$f_cierre3= $c3[0].'/'.$c3[1].'/'.$c3[2];


$fecha = new Datos();
$normal = $fecha->cambiaf_a_mysql($periodo);
