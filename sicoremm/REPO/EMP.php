...
?>
<?php
echo '<strong>CONVENIO EMPRESAS '.$fechainicio[0].'-'.$fechainicio[1].'-'.$fechainicio[2].' al '.$fechatermino[0].'-'.$fechatermino[1].'-'.$fechatermino[2].'</strong>';
