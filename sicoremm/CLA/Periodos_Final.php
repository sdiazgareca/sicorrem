...
class Periodos_Final {
    ...
    public $table ='<table class="table2">';
    ...
    function entregaActual($periodo,$periodo1,$periodo2,$cod_cobrador,$tabla){
        ...
        $sql = $this->queryPagos." WHERE t_mov.operador='D' AND fecha_mov = '".$periodo."' AND DEV =0 AND
                                   afectacion < 1 AND
        ...
        $sql = $this->queryPagos." WHERE t_mov.operador='H' AND fecha_mov = '".$periodo."' AND DEV =0 AND
    ...
    function entregaAnterior($periodo,$periodo1,$periodo2,$cod_cobrador,$tabla){
        ...
        $periodoAnterior2 = date("Y-m-01", strtotime("$periodo - 1 days"));
          ...
          $sql = $this->queryPagos." WHERE  (contratos.f_baja='0000-00-00' || contratos.f_baja < '".$periodo1."' ) AND cta.fecha_mov BETWEEN '".$periodoAnterior1."' AND '".$periodoAnterior2."' AND DEV =0 AND
        ...
        while($detalle = mysql_fetch_array($query)){
          ...
          $sql = $this->queryPagos." WHERE  cta.fecha_mov BETWEEN '".$periodoAnterior1."' AND '".$periodoAnterior2."' AND DEV =0 AND
