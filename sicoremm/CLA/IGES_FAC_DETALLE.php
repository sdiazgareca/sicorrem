...
//DEVUELVE ENTREGA CORREPONDIENTE AL MES ESPECIFICADO < ó = el uso de > BLOQUEADO
    function cob_entrega_pen($periodo,$desde,$hasta,$cobrador,$dev,$operador_periodo,$operador_cob){
        ...
        while ($debe = mysql_fetch_array($query) ){
            ...
            echo "<tr><td>".$debe['titular']."</td><td>".$debe['num_solici']."</td><td>".$debe['comprovante']."</td><td>".$debe['fecha_mov']."</td><td>".$debe['debe']."</td><td>".$debe['f_rendicion']."</td></tr>";
    ...
    function cob_entrega_cob($periodo,$desde,$hasta,$cobrador,$dev,$operador_periodo,$operador_cob){
        ...
        while ($debe = mysql_fetch_array($query) ){
            ...
            $importe = $importe + $debe['haber'];
             echo "<tr><td>".$debe['titular']."</td><td>".$debe['num_solici']."</td><td>".$debe['comprovante']."</td><td>".$debe['fecha_mov']."</td><td>".$debe."</td><td>".$debe['f_rendicion']."</td></tr>";
    ...
    function cob_recuperado($periodo,$desde,$hasta,$cobrador,$dev,$operador_periodo,$operador_cob){
        ...
        while ($debe = mysql_fetch_array($query) ){
            ...
            $importe = $importe + $debe['haber'];
             echo "<tr><td>".$debe['titular']."</td><td>".$debe['num_solici']."</td><td>".$debe['comprovante']."</td><td>".$debe['fecha_mov']."</td><td>".$debe['haber']."</td><td>".$debe['f_rendicion']."</td></tr>";
    ...
    function cob_pendiente($periodo,$periodo1,$periodo2,$cod_cobrador){
        ...
        while($debe = mysql_fetch_array($query2)){
...
function ofi_entrega_cob($periodo,$desde,$hasta,$cobrador,$dev,$operador_periodo,$operador_cob,$f_pago){
 ...
 echo "<tr><td>".$debe['titular']."</td><td>".$debe['num_solici']."</td><td>".$debe['comprovante']."</td><td>".$debe['fecha_mov']."</td><td>".$haber['haber']."</td><td>".$debe['f_rendicion']."</td></tr>";
...
//EVENTOS TRASLADOS MEDIMEL
  ...
  function convenios_entrega_pen($periodo,$desde,$hasta,$cobrador,$dev,$operador_periodo,$operador_cob,$f_pago){
        ...
        while ($debe = mysql_fetch_array($query) ){
            ...
            $importe = $importe + $debe['debe'];
             echo "<tr><td>".$debe['empresa']."</td><td>".$debe['titular']."</td><td>".$debe['num_solici']."</td><td>".$debe['comprovante']."</td><td>".$debe['fecha_mov']."</td><td>".$debe['debe']."</td><td></td></tr>";
...
function convenio_entrega_cob($periodo,$desde,$hasta,$cobrador,$dev,$operador_periodo,$operador_cob,$f_pago){
        ...
        while ($debe = mysql_fetch_array($query) ){
            ...
            $importe = $importe + $debe['haber'];
             echo "<tr><td>".$debe['empresa']."</td><td>".$debe['titular']."</td><td>".$debe['num_solici']."</td><td>".$debe['comprovante']."</td><td>".$debe['fecha_mov']."</td><td>".$debe['haber']."</td><td>".$debe['f_rendicion']."</td></tr>";
...
function convenios_ofi_pendiente($periodo,$periodo1,$periodo2,$cod_cobrador,$f_pago){
        ...
        while($debe = mysql_fetch_array($query2)){
            ...
            $monto = $monto + $debe['haber'];
             echo "<tr><td>".$debe['empresa']."</td><td>".$debe['titular']."</td><td>".$debe['num_solici']."</td><td>".$debe['comprovante']."</td><td>".$debe['fecha_mov']."</td><td>".$debe['haber']."</td><td></td></tr>";
        }
