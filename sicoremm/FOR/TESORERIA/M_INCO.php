...
<form action="INT/M_TESO_INCO.php" method="post" id="F_AUDI" name="F_AUDI">
...
<input type="text" name="cat_venta" maxlength="11" VALUE="200" />
<input type="text" name="estado_venta" maxlength="11" VALUE="200" />
