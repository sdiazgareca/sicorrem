...
<div class="caja">
 ...
 <label for="ContactName">C&oacute;digo</label> <input type="text" name="cod_plan" size="3" maxlength="3"/>
 </td>
 <td>
...
?>
 ...
 <td><label for="ContactName">Valor Copago</label></td><td><input type="text" name="copago" /></td>
 </tr>
 
<tr>

<td><label for="ContactName">Casa Protegida</label>&nbsp;&nbsp;SI<input name="casa_p" type="radio" value="SI" />NO<input name="casa_p" type="radio" value="NO" /></td>
<td>N&uacute;mero de Atenciones Sin Copago</td>
<td><input value="0" type="text" size="2" maxlength="2" name="cm_gratis" />&nbsp;<select name="tiempo"><option value="ANUAL">Anual</option><option value="MENSUAL">Mensual</option></select></td>
<td><label>Valor Incor</label></td><td><input name="v_incor" type="text" id="v_incor"/></td>
</tr>
