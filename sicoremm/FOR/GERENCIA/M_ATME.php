...
<form action="INT/M_ATME.php" method="post" id="ing_at_med" name="ing_at_med" >
...
<div class="caja">
<input type="text" name="ff_bus_ante_med" style="display:none" /> 
...
<a href="FOR/GERENCIA/F_ATME.php?listado=1" class="boton2" id="ing">INGRESO ANTECEDENTES MEDICOS</a>
</div>
