...
if ($_GET['Contratante'] > 0 || $_POST['Contratante'] > 0){
    ...
    $query12="UPDATE afiliados SET afiliados.cod_baja ='".$baja[1]."', afiliados.fecha_baja='".date('Y-m-d')."' WHERE num_solici = '".$num_solici."' AND afiliados.cod_baja != '01'";
...
if($_POST['copago_cam'] > 0){
    ...
    $sql = "UPDATE `copago` SET `copago`.`cobrador`='".$_POST[$cobrador]."', `tipo_pago`='".$_POST[$tipo_pago]."' WHERE `protocolo`='".$_POST[$protocolo]."'";
    //echo '<br />'.$sql.'<br />';
...
<!--
<h2>
    <a href="BUSQ/GESTOR_PAGOS.php?f_cop=Mensualidad&CONTRATO=<?php// echo $_GET['CONTRATO']; ?>&RUT=<?php // echo $_GET['RUT']; ?>">Mensualidades</a>&zwj;&zwj;
    <a href="BUSQ/GESTOR_PAGOS.php?f_cop=N_Credito&CONTRATO=<?php// echo $_GET['CONTRATO']; ?>&RUT=<?php // echo $_GET['RUT']; ?>">N_Credito</a>
    <a href="BUSQ/GESTOR_PAGOS.php?f_cop=INTERESES&CONTRATO=<?php// echo $_GET['CONTRATO']; ?>&RUT=<?php // echo $_GET['RUT']; ?>">Intereses y Gastos de Cob</a>
    <a href="BUSQ/GESTOR_PAGOS.php?f_cop=REMPLAZOS&CONTRATO=<?php// echo $_GET['CONTRATO']; ?>&RUT=<?php // echo $_GET['RUT']; ?>">Remplazos</a>
</h2>
-->
<div id="g_pago">
