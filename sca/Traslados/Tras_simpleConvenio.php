...
$consulta = "insert into traslados(cod,tipo_traslado,convenio,fecha_traslado,Direccion_origen, Direccion_destino,ciudad,costo,estado,tipo_plan,valor) values ('".$cod."',2,'".$_GET['convenio']."','".$_GET['fecha_traslado']."','".$_GET['direco']."','".$_GET['direccion_destino']."','".$_GET['ciudad']."','".$_GET['costo']."','0',6,'".$_GET['valor_e']."')";
$resultados = mysql_query($consulta);

$consulta2="INSERT INTO fichas (tipo_plan,color,correlativo,traslado,paciente,telefono,celular,hora_llamado,obser_man,estado) VALUES ('TRA_CONV','4','".$cod."','".$cod."','".$_GET['paciente']."','".$_GET['telefono']."','".$_GET['celular']."','".$hora_llamado."','TRA','0')";
...
<tr>
<td class="celda1"><h1  style="color:#FFFFFF">Traslado Simple Convenio</h1></td>
</tr>
</table>
<table style="width:480px;">
<tr>
...
<select id="convenio">
<?php
$planes_tras = "select tipo_plan, cod_plan, desc_plan from planes_traslados where tipo_plan ='6' and cod_plan != 'TRA3' ";
$resultados_plan = mysql_query($planes_tras);
while ($resultados_plan_tr = mysql_fetch_array($resultados_plan)){
?>
<option value="<?php echo $resultados_plan_tr['cod_plan'];?>"><?php echo $resultados_plan_tr['desc_plan'];?></option>
<?
}
?>
</select>
...
<br /><br />
Paciente&nbsp;<input type="text" id="paciente_convenio" size="30">
<br /><br />
...
<br /><br/>
C. Hospitalario&nbsp;
<input value="1" type="radio" id="dir2" name="dir" onclick="$ajaxload('lugarr','Traslados/centrohospitalario.php',false,false,false);" />&nbsp;
...
<div id="lugarr"></div>
<br /> <br />
<div align="right"><input type="button" value="Guardar" onclick="guradar_traslado('Tras_simpleConvenio.php',document.getElementById('convenio').value,'6')" class="boton"></div></td>
</tr>
</table>
<?
