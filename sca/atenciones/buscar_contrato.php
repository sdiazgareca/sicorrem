...
where afiliados.num_solici ='".$_GET['protocolo']."'";
...
<div align="right"><input type="button" value="Listado Atenciones" class="boton" onclick="$ajaxload('info', 'atenciones/buscar_contrato?protocolo=<?php echo $_GET['protocolo']; ?>',false,false);" /></div>
