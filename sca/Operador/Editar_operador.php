...
$query1 = "update operador set estado='1' where rut='".$_GET['rut']."'";
...
<td class="celda3"><div align="right"><input type="button" class="boton" value="Activar" 

onclick="

if(confirm('Esta seguro de activar el usuario?')) {

$ajaxload('operadores', 'Operador/Editar_operador.php?rut=<?php echo $matriz_resultados['rut']; ?>','<div class=mensaje><p><img src=IMG/bigrotation2.gif/></p><p>Cargando</p></div>',false,false);}"></div></td>
</tr>
<?php
}
?>
