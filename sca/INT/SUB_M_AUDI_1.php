...
if( isset($_POST['ff_ingres'])){
	...
	if($_POST['ff_pago'] == 300){
		...
		$val = array("tipo_plan"=>$_POST['ff_tipo_plan'],"cod_plan"=>$_POST['ff_plan'],"nro_doc"=>$datos->nro_doc,"num_solici"=>$n_contrato['folio'],"tipo_dom"=>"1","cod"=>$cod-num,"poblacion"=>$_POST['poblacion'],"pasaje"=>$_POST['ff_pasaje'],"numero"=>$_POST['ff_numero'],"departamento"=>$_POST['departamento'],"piso"=>$_POST['piso'],"localidad"=>$_POST['localidad'],"telefono"=>$_POST['telefono'],"entre"=>$_POST['entre']);
	...
	if($_POST['ff_tipo_plan'] == 3){
		...
		$cod->CompData('cod','domicilios');
		$domi = new Datos;
		$val = array("tipo_plan"=>$_POST['ff_tipo_plan'],"cod_plan"=>$_POST['ff_plan'],"nro_doc"=>$datos->nro_doc,"num_solici"=>$n_contrato['folio'],"tipo_dom"=>"5","cod"=>$cod-num +1,"poblacion"=>$_POST['ff_a_poblacion'],"pasaje"=>$_POST['ff_a_pasaje'],"numero"=>$_POST['ff_a_numero'],"departamento"=>$_POST['ff_a_departamento'],"piso"=>$_POST['ff_a_piso'],"localidad"=>$_POST['ff_a_localidad'],"telefono"=>$_POST['ff_a_telefono']);
...
//FECHA CONTRATO
        ...
        $fes = explode('-', $_POST['ff_f_contrato']);
	...
	if ($_POST['ff_fpago'] > 39 && $_POST['ff_fpago'] < 41){
		$veta = 'INSERT INTO
		ventas_reg(tipo_plan,cod_plan,ff_factu,mes_pago_inicial,num_solici,titular,vendedor,monto,fecha,cat_venta,estado_venta,pago_venta,n_documento,
		fecha_documento,t_documento,sec)
		VALUES ("'.$_POST['ff_tipo_plan'].'","'.$_POST['ff_cod_plan'].'","'.$_POST['ff_factu'].'","'.$fecha_mes.'","'.$n_contrato['folio'].'","'.$rutt->nro_doc.'","'.$_POST['ff_vendedor'].'",
	...
	$domi2 = new Datos;
        ...
        $val = array("tipo_plan"=>$_POST['ff_tipo_plan'],"cod_plan"=>$_POST['ff_plan'],
            "nro_doc"=>$datos->nro_doc,"num_solici"=>$n_contrato['folio'],"tipo_dom"=>"2","cod"=>$cod2->num,"calle"=>$_POST['ff_a_poblacion_par'],"pasaje"=>$_POST['ff_a_pasaje_par'],"numero"=>$_POST['ff_a_numero_par'],"departamento"=>$_POST['ff_a_departamento_par'],"piso"=>$_POST['ff_a_piso_par'],"localidad"=>$_POST['ff_a_localidad_par'],"telefono"=>$_POST['ff_a_telefono_par'],"entre"=>$_POST['ff_a_entre_par']);
