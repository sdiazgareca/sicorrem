...
if ($_POST['BOLL']){
	...
	$query2['boleta'] = "UPDATE ventas_reg SET ff_factu='".$_POST['tipo_doc']."',tipo_plan='".$comi['tipo_plan']."',cod_plan='".$comi['cod_plan']."',estado_venta='100', n_documento='".$_POST['n_boleta']."',locominion='".$comi['locomocion']."',comision='".$comision."', porcentaje = '".$comi['comi_free']."' WHERE num_solici='".$_POST['num_solici']."' AND cat_venta='200' AND vendedor='".$comi['vendedor']."'";
        ...
        $query2['cta'] ="INSERT INTO cta
            ...
            VALUES ('".$_POST['tipo_doc']."','50','1','".$comi['titular']."','".$_POST['n_boleta']."','100','','".$comi['mes_pago_inicial']."','".$comi['monto']."','1','".$_POST['num_solici']."','".$comi['monto']."')";
...
/*
	...
	echo '<br /><h1>PAGO INICIAL</h1>';
        ...
        if (isset($_GET['CONTRATO'])){
            $contrata =$_GET['CONTRATO'];
        }

        if (isset($_POST['num_solici'])){
            $contrata =$_POST['num_solici'];
        }

	$sql3 = "SELECT cod_pago_venta,des_pago_venta FROM REG_VENTAS WHERE num_solici ='".$contrata."'";
	$query3 = mysql_query($sql3);
	$doc_pago = mysql_fetch_array($query3);


        echo 'prueba doc_pago '.$doc_pago['cod_pago_venta'];
