...
<?php
$consulta = "select afiliados.nro_doc as nro_doc,nombre1,nombre2,apellido,mot_baja.descripcion as descripcion1,mot_baja.codigo,categoria.descripcion as descripcion2,tipo_plan.tipo_plan_desc,reducido, planes.desc_plan,grupo_nd,planes.cod_plan,obras_soc.nro_doc as isapre,num_solici
from afiliados 
...
<div align="right"><input type="button" value="Listado Atenciones" class="boton" onclick="$ajaxload('bus', 'PHP/natenciones.php?rut=<?php echo $matriz_resultados['nro_doc']; ?>',false,false);" /></div>
...
while($matriz_resultados2 = mysql_fetch_array($resultados2)){
	...
	<td><input type="button" value="Ver" class="boton" onclick="$ajaxload('det', 'php/natenciones2.php?protocolo=<?php echo $matriz_resultados2['correlativo']; ?>',false,false,false);" /></td>
    </tr>
    <?php
}
?>
