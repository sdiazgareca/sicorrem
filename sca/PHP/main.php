...
$query = "update fichas set  $consulta_para_hora='".$fecha."' where movil='".$_GET['movil']."' and estado = 1";
...
$Buscar_Rut->MuestraCargas($conexion,$_GET['grupo_nd']);
exit;
}
...
if($rut && $_GET['busq2'] > 0){
$Buscar_Rut = new Afiliados;
$Buscar_Rut->BuscarRut301($conexion,$mensaje1,$rut);
exit;
}
...
if($rut && !$_GET['busq2']){
$Buscar_Rut = new Afiliados;
$Buscar_Rut->BuscarRut($conexion,$mensaje1,$rut,$_GET['contratito']);
exit;
}
