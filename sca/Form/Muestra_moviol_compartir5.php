...
onclick="$ajaxload('movil_asignados_<?php echo $correlativo; ?>', 'Form/Muestra_moviol_compartir6.php?correlativo=<?php echo $correlativo; ?>&num=<?php echo $num; ?>&movil=<?php echo $movil; ?>',false,false,false);">
&ccedil;Movil Compartido</a>
...
<?php
$consultare = "select cod,espera from movil_espera where estado = 1";		
...
cambiar_amb3(this.value,'<?php echo $correlativo; ?>','<?php echo $num;?>');}" value="<?php echo $matriz_resultadosre['cod']; ?>"><?php echo 'Espera '.$matriz_resultadosre['espera']; ?></option>
<?php
}
?>
</select>
