...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="boton1" onclick="MuestraVentana('control_de_tiempos','<?php echo $matriz_resultados['nro_doc']; ?>','<?php echo $matriz_resultados['correlativo']; ?>')"><img src="IMG/time.png" width="16" height="16" /></a>Asignar horario eee
</h1>
...
<option value="0">&nbsp;</option>
<?php
$query = "select cod,destino from destino where cod = 42";
$respuesta = mysql_query($query);
...
&nbsp;
Forma de Pago&nbsp;<select id="tipopago">
...
<br /><br />
<div align="right"><input type="button" class="boton" value="Guardar" /></div>
</td>
</tr>
<?php
}
