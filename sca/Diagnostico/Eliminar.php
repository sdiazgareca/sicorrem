...
if ( isset($cod) ){
$con = "update diagnostico set estado='0' where cod='".$cod."' ";
...
<td class="celda3"><div align="right">
  ...
  &nbsp;
  <input type="button" value="Buscar" class="boton" onclick="$ajaxload('sintomas', 'Diagnostico/Eliminar.php?busq='+document.getElementById('busq').value,'<div class=mensaje><p><img src=IMG/bigrotation2.gif/></p><p>Cargando</p></div>',false,false);" /></div></td>
</tr>
</table>
...
$ajaxload('sintomas', 'Diagnostico/Eliminar.php?cod=<?php echo $matriz_resultados['cod']; ?>','<div class=mensaje><p><img src=IMG/bigrotation2.gif/></p><p>Cargando</p></div>',false,false);}" class="boton" value="Eliminar" /></div></td>
</tr>
