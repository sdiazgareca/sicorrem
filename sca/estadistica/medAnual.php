...
and (obser_man = 24 ||  obser_man = 42 || obser_man = 45) and fichas.estado=0 order by nro_doc";
...
<?php
$grupo_nd_sql="SELECT titular
from afiliados
WHERE afiliados.nro_doc='".$matriz_resultados['nro_doc']."'  and afiliados.cod_plan ='W71' and afiliados.tipo_plan='2'";

$grupo_nd_query = mysql_query($grupo_nd_sql);
$grupo_nd = mysql_fetch_array($grupo_nd_query);

$titular="select obras_soc.nro_doc as cod_isa,descripcion,nombre1,titular,afiliados.apellido
from afiliados
INNER JOIN obras_soc ON afiliados.obra_numero = obras_soc.nro_doc
WHERE afiliados.nro_doc='".$grupo_nd['grupo_nd']."'  and afiliados.cod_plan ='W71' and afiliados.tipo_plan='2' and afiliados.categoria='1'";
...
<td><?php echo $titular_m['apellido']; ?></td>
