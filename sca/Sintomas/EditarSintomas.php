...
<input type="button" onclick="$ajaxload('sintomas', 'Sintomas/Form_editar_sintomas.php?cod=<?php echo $matriz_resultados['cod']; ?>','<div class=mensaje><p><img src=IMG/bigrotation2.gif/></p><p>Cargando</p></div>',false,false);" class="boton" value="Editar" /></div></td>
</tr>
